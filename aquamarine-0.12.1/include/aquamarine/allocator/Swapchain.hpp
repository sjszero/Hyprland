...
namespace Aquamarine {
    ...
    class CSwapchain {
      public:
        ...
        // in use.
        void rollback();
        // refreshes all buffers in the swapchain by re-acquiring them from the allocator.
        // useful for backends where the underlying buffer objects may change (e.g. Anland).
        void refreshBuffers();
